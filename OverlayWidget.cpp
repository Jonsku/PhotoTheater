...
bool OverlayWidget::eventFilter(QObject *, QEvent *event) {
    if (event->type() == QEvent::Move ||
       ...
       // qDebug() << "OverlayWidget:eventFilter: enable";
        enable();
    } else if (event->type() == QEvent::Hide) {
        //qDebug() << "OverlayWidget:eventFilter: disable";
        disable();
    }
