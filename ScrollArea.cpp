...
int ScrollArea::numberOfWidgets(){
...
void VScrollArea::removeWidget(int ind){
    QWidget * w = childWidgets[ind];
    childWidgets.erase( childWidgets.begin()+ind);
    contents->setGeometry(0, -current*height(), width(), height()*childWidgets.size());
}
...
void HScrollArea::removeWidget(int ind){
    QWidget * w = childWidgets[ind];
    childWidgets.erase( childWidgets.begin()+ind);
    contents->setGeometry(-current*width(), 0, width()*childWidgets.size(), height());
}
